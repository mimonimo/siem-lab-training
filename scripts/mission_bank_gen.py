...
PRIMERS = {
 ...
 9:  "권한 상승은 일반 권한에서 root 권한을 얻는 것입니다. sudoers.d 디렉터리에 새로 생긴 파일이 권한 백도어입니다.",
 ...
 30: "sudoers 백도어의 핵심 키워드는 NOPASSWD(비밀번호 없이 sudo 실행)입니다. 대문자·콜론이 있어 검색은 와일드카드(full_log:*NOPASSWD*)가 필요합니다.",
